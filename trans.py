...
# 	Bw = q2[3]
# 	Q = np.zeros(4)
# 	Q[0] = np.multiply( Ax,Bw) + np.multiply(Ay,Bz) - np.multiply(Az,By) + np.multiply(Aw,Bx)
# 	Q[1] = np.multiply(-Ax,Bz) + np.multiply(Ay,Bw) + np.multiply(Az,Bx) + np.multiply(Aw,By)
# 	Q[2] = np.multiply( Ax,By) - np.multiply(Ay,Bx) + np.multiply(Az,Bw) + np.multiply(Aw,Bz)
# 	Q[3] = np.multiply(-Ax,Bx) - np.multiply(Ay,By) - np.multiply(Az,Bz) + np.multiply(Aw,Bw)
# 	return Q
